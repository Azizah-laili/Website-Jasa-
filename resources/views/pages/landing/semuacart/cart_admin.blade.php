...
@section('content')
<!-- DESAIN CART SECTION -->
<form action="{{ route('add_to_desaincart', $logo) }}" method="POST">
  @csrf
          ...
          <div class="mt-8">
            ...
            <div class="grid mt-6 text-center sm:grid-cols-2 lg:max-w-7xl xl:max-w-6xl xl:mx-auto 2xl:text-left">
              <div class="px-5 py-6 bg-yellow-100 sm:bg-gradient-to-l sm:from-yellow-100 sm:to-white">
                ...
                <p class="font-extrabold text-base mt-4 text-gray-700 lg:max-w-xs lg:mx-auto 2xl:max-w-[500px] 2xl:text-4xl 2xl:mt-[25px]">{{ $logo->name_logo }}</p>
              </div>
              <div class="px-5 py-6 bg-teal-100 from-teal-100 sm:bg-gradient-to-r sm:to-white">
                ...
                <p class="font-extrabold text-base mt-4 text-gray-700 lg:max-w-xs lg:mx-auto 2xl:text-4xl 2xl:mt-[25px] 2xl:max-w-[500px]">{{ $logo->harga_logo }}</p>
              </div>
            </div>
          </div>
          <div class="mt-8">
