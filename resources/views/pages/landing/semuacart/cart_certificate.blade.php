...
@section('content')
<!-- DESAIN CART SECTION -->
<form action="{{ route('add_to_certificatecart', $certificate) }}" method="POST">
  @csrf
          ...
          <div class="mt-8">
            ...
            <div class="grid mt-6 text-center sm:grid-cols-2 lg:max-w-7xl xl:max-w-6xl xl:mx-auto 2xl:text-left">
              <div class="px-5 py-6 bg-yellow-100 sm:bg-gradient-to-l sm:from-yellow-100 sm:to-white">
                ...
                <p class="font-extrabold text-base mt-4 text-gray-700 lg:max-w-xs lg:mx-auto 2xl:max-w-[500px] 2xl:text-4xl 2xl:mt-[25px]">{{ $certificate->name_certificates }}</p>
              </div>
              <div class="px-5 py-6 bg-teal-100 from-teal-100 sm:bg-gradient-to-r sm:to-white">
                ...
                <p class="font-extrabold text-base mt-4 text-gray-700 lg:max-w-xs lg:mx-auto 2xl:text-4xl 2xl:mt-[25px] 2xl:max-w-[500px]">{{ $certificate->harga_certificates }}</p>
              </div>
            </div>
          </div>
          <div class="mt-8">
            ...
            <div class="w-full mt-4"><label class="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200">
              ...
              <form class="flex justify-center gap-10 py-5 mx-auto my-5 ">
                <div class="flex justify-center gap-4 py-5 mx-auto my-5 ">
                  <a href="{{ route('certificate.landing') }}" class="inline-block px-8 py-3 text-sm font-semibold text-center text-gray-900 transition duration-100 border border-indigo-500 rounded-lg outline-none hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 md:text-base 2xl:py-5" >
                    < Cancel</a>
