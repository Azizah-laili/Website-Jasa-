...
@section('title','Jasa certificate')
@section('content')
        ...
        <div class="flex grid items-center gap-12 lg:grid-cols-2">
          ...
          <div class="mx-auto mt-12 text-left md:px-10 lg:mt-0">
            <h1 class="my-12 text-3xl font-bold tracking-tight uppercase judul">
              JASA DESAIN SERTIFIKAT BERKUALITAS!</h1>
              <p class="mb-12 text-justify judul">Dapatkan desain sertifikat murah berkualitas,
                elegan, dan profesional dengan harga yang
                kompetitif terjangkau.</p>
              <div class="rata">
                  @if (Route::has('login'))
                  @auth
                  <a class="inline-block py-3 mr-2 text-sm font-medium leading-snug text-white uppercase transition duration-150 ease-in-out rounded shadow-md bg-color-third px-7 hover:bg-white hover:text-blue-900 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 " data-mdb-ripple="true" data-mdb-ripple-color="light" href="#certificate" role="button">Get started</a>
          ...
          <div class="mx-auto mb-12 lg:mb-0">
            <img src="{{ asset('/images/jasa_certificate.png') }}" class="w-11/12 rounded-lg shadow-lg" alt=""/>
          </div>
        </div>
      </div>
    </div>
...
<div class="max-w-full px-4 py-16 mx-auto transition-transform bg-blue-200 md:px-24 lg:px-8 " data-aos="fade-up">
  <div class="w-full mb-10 md:mx-auto sm:text-center md:mb-12">
    ...
    <p class="text-base text-center md:text-lg">Butuh sertifikat yang elegan dan bagus, mulailah desain di Algotech!</p>
  </div>
  ...
  <div class="grid gap-8 row-gap-5 pb-20 md:row-gap-8 lg:grid-cols-3">
    ...
    <div class="p-5 duration-300 transform bg-white border-2 border-dashed shadow-sm hover:-translate-y-2 border-primary-500 dark:bg-gray-900 rounded-global">
      ...
      <p class="text-sm">Dengan sertifikat berkualiatas anda bisa dapatkan dengan hargai sesuai budget.</p>
    </div>
...
<!--END REASON SERTIFIKAT-->

<!-- DESAIN SERTIFIKAT-->
  <section id="certificate" class="py-8 my-20 leading-7 sm:py-12 md:py-16 lg:py-24">
    <div class="box-border px-4 mx-auto border-solid sm:px-6 lg:px-8 max-w-7xl">
      <div class="flex flex-col items-center py-10 leading-7 text-center border-0 border-gray-200 text-color-second">
        <h2 class="box-border m-0 text-3xl font-black leading-tight tracking-tight border-solid text-color-second dark:text-white md:text-4xl lg:text-4xl">PAKET JASA DESAIN SERTIFIKAT</h2>
      ...
      <div class="grid grid-cols-1 gap-4 mt-4 leading-7 border-0 border-gray-200 dark:border-primary-500 sm:mt-6 sm:gap-6 md:mt-8 md:gap-0 lg:grid-cols-3 xl:max-w-8xl xl:mx-auto" data-aos="fade-up">
        ...
        <div class="relative z-10 flex flex-col items-center max-w-md p-4 mx-auto my-0 border border-solid rounded-global dark:border-gray-700 sm:p-6 md:my-8 md:p-8 lg:-mr-3">
          <h3 class="m-0 text-2xl font-semibold leading-tight tracking-tight border-0 border-gray-200 text-color-second dark:text-white sm:text-3xl md:text-4xl">{{ $certificate->name_certificates}}</h3>
          <div class="flex items-end pb-5 mt-3 leading-7 border-0 border-gray-200 text-color-second">
            <p class="rupiah">Rp</p>
            <p class="box-border m-0 text-4xl font-semibold leading-none border-solid md:text-6xl text-primary-500">{{ $certificate->harga_certificates}}</p>
          </div>
          ...
          <form action="{{ route('cart_certificate.landing', $certificate) }}" method="get">
