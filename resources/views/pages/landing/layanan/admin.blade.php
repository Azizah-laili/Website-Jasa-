...
@section('title','Admin sosmed')
@section('content')

<!-- HERO DESAIN ADMIN SECTION -->
        ...
        <div class="flex grid items-center gap-12 lg:grid-cols-2">
          ...
          <div class="mx-auto mt-12 text-left md:px-10 lg:mt-0">
            <h1 class="my-12 text-3xl font-bold tracking-tight judul">
              KELOLA SOSIAL MEDIA TANPA URUS TIM DAN TANPA MIKIR KONTEN SERTA DESAINNYA</h1>
              <p class="mb-12 text-justify judul">100% biar kami yang urus Sosial Media
                bisnis kamu. Sehingga kamu bisa fokus
                pada target yang ingin dituju.</p>
                <div class="rata">
                  @if (Route::has('login'))
                  @auth
                  <a class="inline-block py-3 mr-2 text-sm font-medium leading-snug text-white uppercase transition duration-150 ease-in-out rounded shadow-md bg-color-third px-7 hover:bg-white hover:text-blue-900 hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 " data-mdb-ripple="true" data-mdb-ripple-color="light" href="#admin" role="button">Get started</a>
          ...
          <div class="mx-auto mb-12 lg:mb-0">
            <img src="/images/jasa_admin.avif" class="w-11/12 rounded-lg shadow-lg" alt=""/>
          </div>
        </div>
      </div>
    </div>
...
<!-- END HERO DESAIN ADMIN SECTION -->

<!-- REASON ADMIN SECTION -->
...
<!-- END REASON ADMIN SECTION -->

<!--PAKET ADMIN -->
<section id="admin" class="py-8 my-20 leading-7 sm:py-12 md:py-16 lg:py-24">
  <div class="box-border px-4 mx-auto border-solid sm:px-6 lg:px-8 max-w-7xl">
    <div class="flex flex-col items-center py-10 leading-7 text-center border-0 border-gray-200 text-color-second">
      <h2 class="box-border m-0 text-3xl font-black leading-tight tracking-tight border-solid text-color-second dark:text-white md:text-4xl lg:text-4xl">PAKET JASA ADMIN SOSIAL MEDIA</h2>
    ...
    <div class="grid grid-cols-1 gap-4 mt-4 leading-7 border-0 border-gray-200 dark:border-primary-500 sm:mt-6 sm:gap-6 md:mt-8 md:gap-0 lg:grid-cols-3 xl:max-w-8xl xl:mx-auto" data-aos="fade-up">
      ...
      @foreach ($admin_sosmeds as $admin_sosmed)
      <div class="relative z-10 flex flex-col items-center max-w-md p-4 mx-auto my-0 border border-solid rounded-global dark:border-gray-700 sm:p-6 md:my-8 md:p-8 lg:-mr-3">
        <h3 class="m-0 text-2xl font-semibold leading-tight tracking-tight border-0 border-gray-200 text-color-second dark:text-white sm:text-3xl md:text-4xl">{{ $admin_sosmed->name_admin}}</h3>
        <div class="flex items-end pb-5 mt-3 leading-7 border-0 border-gray-200 text-color-second">
          <p class="rupiah">Rp</p>
          <p class="box-border m-0 text-4xl font-semibold leading-none border-solid md:text-6xl text-primary-500">{{ $admin_sosmed->harga_admin}}</p>
        </div>
