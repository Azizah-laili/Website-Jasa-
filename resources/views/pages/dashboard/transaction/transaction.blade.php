                ...
                <div class="mb-4">
                    <nav class="flex mb-5" aria-label="Breadcrumb">
                        ...
                        <li>
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Paket Orderan</span>
                            </div>
                        </li>
                        </ol>
                    </nav>
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Semua paket Orderan</h1>
                </div>
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                        <div class="text-base font-semibold text-gray-900 dark:text-white">
                                            {{App\Helper\Ghelper::product_detail( $transaction->product_name,  $transaction->product_id)->nama }}
                                        </div>
                                    </td>
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{{$transaction->product_id}}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $transaction->id }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{App\Helper\Ghelper::product_detail( $transaction->product_name,  $transaction->product_id)->harga }}</td>

                                   <td class="flex p-4 space-x-2 justify-normal whitespace-nowrap">


                                        <form action="{{ route('confirm_payment_receipt', $transaction) }}" method="post">
                                            @csrf
                                        ...
                                        <form action="{{-- {{ route('delete_transaction', $transaction) }} --}}" method="post">
                                            @method('delete')
                                            @csrf
