                ...
                <div class="mb-4">
                    <nav class="flex mb-5" aria-label="Breadcrumb">
                        ...
                        <li>
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Paket website</span>
                            </div>
                        </li>
                        </ol>
                    </nav>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                        <div class="text-base font-semibold text-gray-900 dark:text-white">{{ $website->name_website }}</div>
                                    </td>
                                    <td class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{!! $website->deskripsi_website !!}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $website->id }}</td>
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $website->harga_website }}</td>

                                    <td class="flex p-4 space-x-2 justify-normal whitespace-nowrap">
                                        <form action="{{ route('edit_website', $website) }}" method="get">
                                        ...
                                        <form action="{{ route('delete_website', $website) }}" method="post">
                                            @method('delete')
                                            @csrf
