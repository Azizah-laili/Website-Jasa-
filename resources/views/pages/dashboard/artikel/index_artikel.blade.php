                ...
                <div class="mb-4">
                    <nav class="flex mb-5" aria-label="Breadcrumb">
                        ...
                        <li>
                            ...
                            <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Paket artikel</span>
                            </div>
                        </li>
                        </ol>
                    </nav>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                ...
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $artikel->id }}</td>
                                    <td class="max-w-sm p-4 text-base font-medium text-gray-900 truncate whitespace-nowrap dark:text-white">{{ $artikel->name_artikel }}</td>
                                    <td><img src="{{ url('storage/' . $artikel->foto_artikel) }}" alt="" width="100px" ></td>
                                    <td >
                                        <div class="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate short lg:max-w-lg dark:text-gray-400 truncate-line-clamp">{!! $artikel->deskripsi_artikel!!}</div></td>

                                    <td class="flex p-4 space-x-2 justify-normal whitespace-nowrap">
                                        <form action="{{ route('edit_artikel', $artikel) }}" method="get">
                                        ...
                                        <form action="{{ route('delete_artikel', $artikel) }}" method="post">
                                            @method('delete')
                                            @csrf
