      ...
      <div class="">
        ...
        <div class="mt-5 shadow-md border border-gray-200 my-2.5 p-5 rounded-global lg:relative 2xl:flex bg-white 2xl:p-[30px]">
          <div class="sm:col-span-4 sm:flex sm:flex-col sm:justify-center">
            ...
            <h1 class="text-xl font-black text-gray-900 ">{{ $product->logo->name_logo }}</h1>
            <p class="text-base font-normal text-gray-500">Deskripsi paket</p>
            <h1 class="text-sm text-gray-900 ">{!! $product->logo->deskripsi_logo !!}</h1>
          </div>
        </div>
          ...
          <div class="px-4 mx-auto max-w-7xl md:px-8">
              ...
              <form  action="{{ route('store_confirm') }}" method="POST" class="grid max-w-screen-md gap-4 mx-auto sm:grid-cols-2">
                ...
                <div class=""><label class="inline-block mb-2 text-sm text-gray-500">Bank Anda</label>
                  <input name="kind_bank" type="text" class="w-full px-3 py-2 text-gray-800 transition duration-100 border rounded outline-none bg-gray-50 focus:ring ring-indigo-300" placeholder="BCA" /></div>

                  <div class=""><label class="inline-block mb-2 text-sm text-gray-500">Bank dituju</label>
                    <input name="bank_dituju" type="text" class="w-full px-3 py-2 text-gray-800 transition duration-100 border rounded outline-none bg-gray-50 focus:ring ring-indigo-300" placeholder="BCA" /></div>

                    
                <div class="sm:col-span-2"><label class="inline-block mb-2 text-sm text-gray-500">Transfer Pada</label>
                  <input name="date_bank" type="date" class="w-full px-3 py-2 text-gray-800 transition duration-100 border border-gray-200 rounded bg-gray-50 focus:ring ring-indigo-300" type="date"/></div>
